...
from manager.views import EntryDetailView, EntryCreate, EntryUpdate
...
urlpatterns = patterns('',
    ...
    url(r'^entry/add$', EntryCreate.as_view(), name='entry'),
    url(r'^entry/update/(?P<pk>\d+)$', EntryUpdate.as_view(), name='entry'),
)
